  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex me-3" role="search">
        ...
        <button class="btn btn-info round-circle" type="submit">
      ...
      <ul class="nav navbar-nav pull-right">
        ...
        ?>
          <a class="navbar-brand" href="<?php echo $rootPath; ?>">
              <img src="https://scontent.fsgn4-1.fna.fbcdn.net/v/t39.30808-1/299839396_753939239190341_8102183110760877527_n.jpg?stp=cp6_dst-jpg_p240x240&_nc_cat=101&ccb=1-7&_nc_sid=7206a8&_nc_ohc=6bfrUgNLinEAX8L1Lnx&_nc_ht=scontent.fsgn4-1.fna&oh=00_AfASqPfjLIjN-v9jv3OuVPJpaKyuu8_CqyTGN3smkYt_qg&oe=644F4AA2" alt="Logo" width="70" height="30" class="d-inline-block align-text-top">
          </a>
          <li class="nav-item">
