                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <p>- Thời gian giao hàng: Thời gian giao hàng từ 30-40 phút. </p>
                            <p>- Giá sản phẩm đã bao gồm thuế VAT</p>
                            <p>- Thời gian làm việc từ 8h00 đến 22h từ thứ 2 đến thứ cn</p>
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <h6>Quý khách có thể thanh toán bằng tiền mặt hoặc thanh toán khi đặt hàng</h6>
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
