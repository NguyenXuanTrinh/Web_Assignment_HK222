    ...
    <div class="row">
        <div class="col-xl-2 col-md-4 col-sm-6">
            <div class="list-group mb-5">
                ...
                ?>
                <a href="<?php echo $rootPath?>/product.php?categoryId=<?php echo $row['category_id']?>" class=" <?php if ($categoryId == $i) echo 'bg-info text-dark bg-opacity-25' ?> list-group-item list-group-item-action "><?php echo $row['category_name']?></a>
                <?php
                        $i++;
                    }
                ?>
                <a href="<?php echo $rootPath?>/product.php?categoryId=0" class="list-group-item list-group-item-action <?php if($categoryId == 0) echo 'bg-info text-dark bg-opacity-25'?>">Xem tất cả</a>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6 col-sm-12 mb-3">
                        ...
                        <div class="card-footer d-flex flex-column">
                            <a href="<?php echo $rootPath?>/product_detail.php?productId=<?php echo $row['product_id']?>" class="btn btn-info">Xem chi tiết</a>
                            ...
                            <button onclick="addCartItem(<?=$row['product_id']?>)" class="btn btn-success mt-1 <?php if ($row["quantity"] == 0) echo 'disabled'?>"><i class="fa-light fa-cart-plus"></i></button>
                        </div>
                        </div>
                    </div>
                    <?php
