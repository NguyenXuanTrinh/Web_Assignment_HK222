        ...
        <div class="col-xl-3 col-md-6 col-sm-12 mb-3">
            ...
            <div class="card-body d-flex flex-column justify-content-between">
                ...
                <div class="card-footer d-flex flex-column">
                    ...
                    <a href="<?php echo $rootPath?>/process_cart.php?action=add&id=<?php echo $row['product_id']?>" class="btn btn-info mt-1 <?php if ($row["quantity"] == 0) echo 'disabled'?>"><i class="fa-light fa-cart-plus"></i></a>
                </div>
            </div>
        </div>
        <?php
